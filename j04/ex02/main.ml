let () =
  ...
  print_endline (string_of_int (Card.compare card2S card10H)) ;
  print_endline "compare KS and QD :" ;
  print_endline (string_of_int (Card.compare cardKS cardQD)) ;
  print_endline "compare AD and AC : " ;
  print_endline (string_of_int (Card.compare cardAD cardAC)) ;
  print_endline "=== max tests ===" ;
  print_endline "max of KS and 10H : " ;
  print_endline (Card.toStringVerbose (Card.max cardKS card10H)) ;
  print_endline "max of 2S and 10H : " ;
  print_endline (Card.toStringVerbose (Card.max card2S card10H)) ;
  print_endline "max of AC and AD : " ;
  print_endline (Card.toStringVerbose (Card.max cardAC cardAD)) ;
  print_endline "=== min tests ===" ;
  print_endline "min of KS and 10H : " ;
  print_endline (Card.toStringVerbose (Card.min cardKS card10H)) ;
  print_endline "min of 2S and 10H : " ;
  print_endline (Card.toStringVerbose (Card.min card2S card10H)) ;
  print_endline "min of AC and AD : " ;
  print_endline (Card.toStringVerbose (Card.min cardAC cardAD)) ;
