class doctor name age sidekick =
  ...
  method to_string = print_endline ("This Doctor's name is " ^ _name ^ " ; he's " ^ (string_of_int _age) ^ " years old ; he has " ^ (string_of_int _hp) ^ "ghp and his sidekick will now introduce herself : ") ; _sidekick#to_string
